    ...
    <div className="container-xxl py-5 category">
      <div className="container">
        <div className="text-center" data-aos="fade-up" data-aos-delay="100">
          ...
          <h1 className="mb-5" style={{ color: 'rgba(0, 0, 255, 0.5)' }}>Popular Topics to Explore</h1>
        </div>
        <div className="row g-2 m-2">
          <div className="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="200">
            <div className="content shadow p-3 mb-2">
              ...
              <h5 className="my-2">
                <p className="text-center">Microsoft Excel</p>
              </h5>
            </div>
          </div>
          ...
          <div className="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="700">
            <div className="content shadow p-3 mb-2">
              ...
              <h5 className="my-2">
                <a href="web" className="text-center">Web Development</a>
              </h5>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="800">
            <div className="content shadow p-3 mb-2">
              ...
              <h5 className="my-2">
                <a href="sql" className="text-center">MySQL</a>
              </h5>
            </div>
          </div>
          <div className="col-lg-3 col-md-6 text-center" data-aos="fade-up" data-aos-delay="900">
            <div className="content shadow p-3 mb-2">
              ...
              <h5 className="my-2">
                <a href="UI" className="text-center">UI/UX Design</a>
              </h5>
            </div>
          </div>
        </div>
